...
public interface BookingService {
    ...
    List<BookingDto> getBookingsForBooker(long userId, BookingState state) throws UserNotFound;

    List<BookingDto> getBookingsForOwner(long userId, BookingState state) throws UserNotFound;
}